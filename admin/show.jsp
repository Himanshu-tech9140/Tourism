...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td><%= rs.getString("confirmpass") %></td>
            <td><a href="code2.jsp?id=<%= rs.getString("id") %>" class="btn-delete">Delete</a></td>
            <td><a href="edit.jsp?id=<%= rs.getString("id") %>" class="btn-edit">Edit</a></td>
        </tr>
        <%
                }
            } catch (Exception ex) {
