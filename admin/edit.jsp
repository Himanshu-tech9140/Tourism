...
<div class="container">
    ...
    <form method="post" action="code3.jsp">
        ...
        <input type="number" required name="phonenumber" value="<%= rs.getString("phonenumber") %>"/>

        <label for="address">Enter Your Address</label>
        <input type="text" required name="address" value="<%= rs.getString("address") %>"/>

        <label for="pincode">Pincode</label>
        <input type="number" required name="pincode" value="<%= rs.getString("pincode") %>"/>

        <label for="dob">Date Of Birth</label>
        <input type="dob" required name="dob" value="<%= rs.getString("dob") %>"/>

        <label for="password">Enter Your Password</label>
        <input type="password" required name="password" value="<%= rs.getString("password") %>"/>

        <label for="confirmpass">Confirm Password</label>
        <input type="password" required name="confirmpass" value="<%= rs.getString("confirmpass") %>"/>
