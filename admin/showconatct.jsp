...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td><%= rs.getString("help") %></td>
            
            <td><a href="contact2.jsp?id=<%= rs.getString("id") %>" class="btn-delete">Delete</a></td>
            <td><a href="editcontact.jsp?id=<%= rs.getString("id") %>" class="btn-edit">Edit</a></td>
        </tr>
        <%
                }
            } catch (Exception ex) {
